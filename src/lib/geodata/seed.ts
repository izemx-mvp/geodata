...
const oppSeeds: Array<Partial<Opportunite> & { titre: string; clientId: string; stage: Opportunite["stage"] }> = [
  ...
  { titre: "Levé bathymétrique et topographique portuaire", clientId: "c10", stage: "Nouveau", type: "Réseau / partenaire", service: "Topographie", localisation: "Tanger", montantEstime: 410000, responsableId: "u3", scoreIA: 72, prochaineAction: "Premier contact technique", echeance: "2026-09-05" },
  ...
  { titre: "Numérisation et géoréférencement d'archives plans", clientId: "c2", stage: "Nouveau", type: "Client existant", service: "SIG", localisation: "Rabat", montantEstime: 145000, responsableId: "u4", scoreIA: 63, prochaineAction: "Cadrer le volume d'archives", echeance: "2026-09-12" },
...
export const notifications: Notification[] = [
  ...
  { id: "n3", type: "Projet", message: "Ahmed Rifai a terminé la tâche « Relevé GPS terrain ».", date: "2026-09-01", lue: false, lien: "/execution" },
  { id: "n4", type: "Validation", message: "3 tâches sont en attente de votre validation.", date: "2026-08-31", lue: false, lien: "/validation" },
  { id: "n5", type: "Rejet", message: "L'administration a rejeté la livraison AFF-2026-041 – R1.", date: "2026-08-31", lue: false, lien: "/rejets" },
  { id: "n6", type: "Retard", message: "La tâche « Traitement photogrammétrique » accuse 3 jours de retard.", date: "2026-08-30", lue: true, lien: "/execution" },
  { id: "n7", type: "Livraison", message: "La livraison de AFF-2026-039 attend le contrôle client.", date: "2026-08-30", lue: true, lien: "/livraisons" },
